...
our $RELEASE = '$Date: 2009-03-19 17:32:09 +0100 (Thu, 19 Mar 2009) $';

# Short description of this plugin
# One line description, is shown in the %SYSTEMWEB%.TextFormattingRules topic:
our $SHORTDESCRIPTION = 'Provide semantic access to icons';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{IconPlugin}{ExampleSetting} = 1;
    ...
    # my $setting = $Foswiki::cfg{Plugins}{IconPlugin}{ExampleSetting} || 0;

    # Register the _EXAMPLETAG function to handle %EXAMPLETAG{...}%
    # This will be called whenever %EXAMPLETAG% or %EXAMPLETAG{...}% is
    # seen in the topic text.
    Foswiki::Func::registerTagHandler( 'ICON', \&_ICON );
...
1;
__END__
This copyright information applies to the IconPlugin:

# Plugin for Foswiki - The Free and Open Source Wiki, http://foswiki.org/
#
# IconPlugin is # This program is distributed in the hope that it will be useful,
# but WITHOUT ANY WARRANTY; without even the implied warranty of
